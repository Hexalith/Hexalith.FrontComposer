...
> **Revalidation note.** The repository baseline moved to .NET SDK `10.0.401` in September 2026. The Story 1.8 measurement table above remains preserved as historical evidence; release certification must capture a fresh `10.0.401` validation row before claiming current hot-reload parity.
