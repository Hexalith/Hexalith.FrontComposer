...
public sealed class CiGovernanceTests {
    ...
    public void Story12_4_Def14_AttestBuildProvenanceStep_IsWiredInReleaseWorkflow() {
        ...
        string attestStep = FindStepBlockContaining(workflow, "actions/attest-build-provenance@v2");
        ...
        string livePublishStep = ExtractNamedStep(workflow, "Run semantic-release (live publish)");
    ...
    public void Story12_4_Def14_AttestationsWritePermission_IsRestored() {
        ...
        string jobPermissions = ExtractJobPermissionsBlock(workflow, "release");
    ...
    public void Story12_4_Def23_ManifestMissingFingerprints_NoRoot_IsBlocked() {
        ...
        try {
            ...
            ProcessResult sealResult = RunPython(root, [
                "eng/release_evidence.py",
                "seal-manifest",
    ...
    private static string FindStepBlockContaining(string workflow, string needle) {
    ...
    private static string ExtractJobPermissionsBlock(string workflow, string jobId) {
