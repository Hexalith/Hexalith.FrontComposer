...
public sealed class SecurityLoggingGovernanceTests
{
    ...
    [
        ...
        "src/Hexalith.FrontComposer.Shell/State/PendingCommands/NewItemIndicatorStateService.cs:CompleteMutation:359:LogWarning",
        "src/Hexalith.FrontComposer.Shell/State/PendingCommands/NewItemIndicatorStateService.cs:CompleteMutation:364:LogInformation",
    ...
    public void ShellSources_HaveExactScopedInventoryAndCollisionFreeSecurityEvents()
    {
        ...
        hotPathEvents.Select(static entry => entry.EventId).Order().ShouldBe(Enumerable.Range(5700, 85));
