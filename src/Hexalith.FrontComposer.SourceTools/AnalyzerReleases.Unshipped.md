...
HFC1002 | HexalithFrontComposer | Warning | Unsupported field type in generated projection or command UI
...
HFC1016 | HexalithFrontComposer | Error | Command property requires a public non-init setter; breaking derivable-setter migration; suppression cannot restore generation
...
HFC1047 | HexalithFrontComposer | Info | Invalid dev-mode annotation site lacks stable descriptor metadata (Story 6-5)
HFC1048 | HexalithFrontComposer | Info | Unsupported dev-mode starter emission level or mismatched component-tree node (Story 6-5)
HFC1049 | HexalithFrontComposer | Info | Dev-mode starter metadata is stale relative to contract version, descriptor hash, or source identity (Story 6-5)
HFC1050 | HexalithFrontComposer | Warning | Custom override interactive element is missing an accessible name (Story 6-6)
HFC1051 | HexalithFrontComposer | Warning | Custom override has a keyboard reachability issue (Story 6-6)
HFC1052 | HexalithFrontComposer | Warning | Custom override suppresses focus visibility (Story 6-6)
...
HFC1058 | HexalithFrontComposer | Warning | Generated UI drift baseline is missing (Story 9-1)
HFC1059 | HexalithFrontComposer | Error | Generated UI drift baseline path is invalid (Story 9-1)
HFC1060 | HexalithFrontComposer | Error | Generated UI drift baseline content is empty or malformed (Story 9-1)
HFC1061 | HexalithFrontComposer | Error | Generated UI drift baseline schema version is unsupported (Story 9-1)
HFC1062 | HexalithFrontComposer | Error | Generated UI drift baseline algorithm version is unsupported (Story 9-1)
HFC1063 | HexalithFrontComposer | Error | Generated UI drift baseline exceeds configured bounds (Story 9-1)
HFC1064 | HexalithFrontComposer | Error | Generated UI drift baseline has duplicate identities or invariant violations (Story 9-1)
HFC1065 | HexalithFrontComposer | Warning | Generated UI structural drift was detected (Story 9-1)
HFC1066 | HexalithFrontComposer | Warning | Generated UI metadata drift was detected (Story 9-1)
HFC1067 | HexalithFrontComposer | Warning | Generated UI drift detector option is invalid (Story 9-1)
HFC1068 | HexalithFrontComposer | Warning | Generated UI drift diagnostics were truncated (Story 9-1)
HFC1069 | HexalithFrontComposer | Error | Generated UI drift diagnostic was suppressed for redaction safety (Story 9-1)
