...
public static class CommandRendererEmitter {
    public static string Emit(CommandRendererModel model) {
        ...
        foreach (PropertyModel property in model.DerivableProperties) {
            string escapedPropertyName = EscapeString(property.Name);
            _ = sb.AppendLine("            case \"" + escapedPropertyName + "\":");
            _ = sb.AppendLine("            {");
            _ = sb.AppendLine("                if (value is null)");
            _ = sb.AppendLine("                {");
            _ = sb.AppendLine("                    _prefilledModel.@" + property.Name + " = default!;");
            _ = sb.AppendLine("                    return true;");
            _ = sb.AppendLine("                }");
            _ = sb.AppendLine();
            _ = sb.AppendLine("                if (!TryConvertPropertyValue<" + property.SourceTypeFullyQualifiedName + ">(value, out " + property.SourceTypeFullyQualifiedName + " converted))");
            _ = sb.AppendLine("                {");
            _ = sb.AppendLine("                    return false;");
            _ = sb.AppendLine("                }");
            _ = sb.AppendLine();
            _ = sb.AppendLine("                _prefilledModel.@" + property.Name + " = converted;");
            _ = sb.AppendLine("                return true;");
            _ = sb.AppendLine("            }");
        }
        ...
        _ = sb.AppendLine("            }");
        _ = sb.AppendLine();
        _ = sb.AppendLine("            converted = (T)convertedValue!;");
        _ = sb.AppendLine("            return true;");
        _ = sb.AppendLine("        }");
