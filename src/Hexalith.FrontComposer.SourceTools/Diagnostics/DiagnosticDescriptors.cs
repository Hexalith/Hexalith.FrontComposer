...
public static class DiagnosticDescriptors {
    ...
    /// <summary>
    /// HFC1016: A property on a <c>[Command]</c> type has an absent, non-public, or init-only setter.
    /// FrontComposer's uniform generated-command shape requires every assignment target, including
    /// derivable properties, to expose a public non-init setter. Change the property to
    /// <c>{ get; set; }</c>. This is a breaking derivable-setter migration; suppressing the
    /// diagnostic cannot restore command generation.
    /// </summary>
