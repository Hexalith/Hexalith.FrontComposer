...
| Gate | Pass condition | Owner | Evidence artifact | State on 2026-09-22 |
| --- | --- | --- | --- | --- |
...
| OI-5 | I — ADOPT-KIT-1; X — EXT-ADOPTER-1; optional A — ADOPT-APP-1 | Product Owner + selected adopter maintainer | FrontComposer publishes the deterministic kit and the selected adopter publishes dated, candidate-bound three-call/projection/command proof. A Parties substitute requires D-7 approval. | G-6 | Open; external proof missing |
