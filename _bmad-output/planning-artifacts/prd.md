...
- Shared-catalog compatibility and dependency provenance decisions are resolved through D-11; GOV-1 carries implementation, BUILD-CAT-1 routes the semantic catalog marker, and BUILD-REL-1 issue 17 remains an explicit external completion/unfreeze gate until its owner-accepted immutable revision is recorded.
