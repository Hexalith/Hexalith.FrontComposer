...
baseline_commit: c3152890304da8957932571f543880657ee266c3
...
- [ ] **Task 6 — Add fixtures, regression proof, documentation, and durable handoff (AC: all)**
  ...
  - [ ] Add policy activation/bootstrap, depth-1 cascade collapse, zero/unavailable push base, exact handoff authentication, immutable workflow/action closure, legacy-manifest audit-only, and graph/policy/workflow fallback invalidation fixtures. Local coverage now proves every listed case except a dedicated zero/unavailable-push-base fixture; that remaining case and real-workflow evidence stay open.
...
- `tests/eng/test_dependency_graph.py` (NEW — 56 synthetic-repository graph/semantic/diff/materialization/policy tests)
