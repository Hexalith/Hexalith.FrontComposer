...
- No external dependency research or package upgrade is needed for this story. Relevant local pins are .NET SDK `10.0.300`, bUnit `2.7.2`, FluentUI Blazor `5.0.0-rc.3-26138.1`, Fluxor `6.9.0`, xUnit v3 `3.2.2`, Shouldly `4.3.0`, and `Microsoft.Extensions.TimeProvider.Testing` `10.6.0`. Do not change package versions. [Source: global.json; Directory.Packages.props; _bmad-output/project-context.md#Technology-Stack-and-Versions]
