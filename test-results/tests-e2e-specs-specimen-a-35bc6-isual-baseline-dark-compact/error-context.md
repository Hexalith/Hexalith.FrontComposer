...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> visual baseline dark compact
...
Call log:
  - navigating to "/__frontcomposer/specimens/type?theme=dark&density=compact", waiting until "load"
