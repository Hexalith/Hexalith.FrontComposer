...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> visual baseline light compact
...
Call log:
  - navigating to "/__frontcomposer/specimens/type?theme=light&density=compact", waiting until "load"
