...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> focus-visible indicator remains visible over lifecycle visuals
- Location: tests/e2e/specs/specimen-accessibility.spec.ts:162:3
