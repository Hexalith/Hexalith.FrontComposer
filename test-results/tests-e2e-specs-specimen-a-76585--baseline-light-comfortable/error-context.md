...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> visual baseline light comfortable
...
Call log:
  - navigating to "/__frontcomposer/specimens/type?theme=light&density=comfortable", waiting until "load"
