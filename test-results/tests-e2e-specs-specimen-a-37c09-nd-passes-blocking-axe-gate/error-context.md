...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> page-toolbar specimen is nonblank and passes blocking axe gate
- Location: tests/e2e/specs/specimen-accessibility.spec.ts:52:5
...
Call log:
  - navigating to "/__frontcomposer/specimens/page-toolbar", waiting until "load"
