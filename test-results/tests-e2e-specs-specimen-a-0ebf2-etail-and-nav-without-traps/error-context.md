...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> keyboard flow reaches skip link, controls, grid, command form, detail, and nav without traps
- Location: tests/e2e/specs/specimen-accessibility.spec.ts:129:3
