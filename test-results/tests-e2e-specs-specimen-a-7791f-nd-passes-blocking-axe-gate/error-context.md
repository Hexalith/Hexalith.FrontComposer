...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> data-formatting specimen is nonblank and passes blocking axe gate
