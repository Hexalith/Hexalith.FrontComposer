...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> forced-colors and reduced-motion states are active and perceivable
- Location: tests/e2e/specs/specimen-accessibility.spec.ts:254:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:5070/__frontcomposer/specimens/type
Call log:
  - navigating to "http://127.0.0.1:5070/__frontcomposer/specimens/type", waiting until "load"
