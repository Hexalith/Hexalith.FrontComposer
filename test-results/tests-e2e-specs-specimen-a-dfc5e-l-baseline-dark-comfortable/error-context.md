...
- Name: tests/e2e/specs/specimen-accessibility.spec.ts >> FrontComposer accessibility and visual specimens >> visual baseline dark comfortable
...
Call log:
  - navigating to "/__frontcomposer/specimens/type?theme=dark&density=comfortable", waiting until "load"
